...
namespace Artemis.Test.AI.Evaluation
{
    ...
    public class PositionEvaluatorTest
    {
        ...
        public void EvaluationTest()
        {
            ...
            int eval1 = evaluator.Evaluate(0, GameStage.Middlegame, out stats1);
            Console.WriteLine(stats1);

            EvaluationStats stats2 = new EvaluationStats();
            gameState.LoadPosition("r4rk1/1ppq1pp1/2npbn1p/p1b1p3/2B1P3/P1PP1N1P/1P1N1PP1/R1BQR1K1 w - - 1 11");
            int eval2 = evaluator.Evaluate(0, GameStage.Middlegame, out stats1);
        }
    }
}
