...
namespace Artemis.Core.AI.Search
{
    public class SearchThread
    {
        ...
        public SearchThread(ThreadMaster master, GameState gameState, TranspositionTable transpositionTable, ConcurrentDictionary<ulong, bool> searchedNodes, IEngineConfig config)
        {
            this.master = master;
